...
- Upstream: [npm package](https://www.npmjs.com/package/jquery)
...
cp "$tmpdir/package/dist/jquery.min.js" static/third_party/jquery/jquery.min.js
cp "$tmpdir/package/LICENSE.txt" static/third_party/jquery/LICENSE.txt
```
