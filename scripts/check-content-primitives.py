...
def check_outputs(public: Path) -> list[str]:
    ...
    for marker in (
        ...
        '<dt class="td-field__name"><code>offlineSearch</code></dt>',
        '<span class="td-field__type"><code>Array&lt;string&gt; | map[string]any</code></span>',
        '<span class="td-field__required">required</span>',
        '<span class="td-field__default"><span>default:</span> <code>false</code></span>',
        '<span class="td-field__default"><span>default:</span> <code>0</code></span>',
        '<span class="td-field__default"><span>default:</span> <code>&#34;&#34;</code></span>',
...
def check_rss_output(hugo: str) -> list[str]:
    ...
    with tempfile.TemporaryDirectory(prefix="oink-primitives-rss-") as temp:
        ...
        for marker in (
            ...
            '<dt class="td-field__name"><code>enabled</code></dt>',
            '<span class="td-field__required">required</span>',
            '<code>false</code>',
