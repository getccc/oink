#!/usr/bin/env python3
"""Build and verify PRD 4 Command Palette modes, data, and runtime gates."""
...
def main() -> int:
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="oink-prd4-palette-") as temporary:
                ...
                for lang in helper.LANGUAGES:
                    ...
                    require(
                        all(token in html for token in (
                            ...
                            'data-t-quick-links=', 'data-t-page-actions=',
                            'data-t-preferences=', 'data-t-commands=',
                            'data-t-no-commands=', 'enterkeyhint="go"',
                        )),
        ...
        print(f"PRD 4 Command Palette check failed: {exc}", file=sys.stderr)
        return 1

    print("PRD 4 Command Palette checks passed")
    return 0
