...
(() => {
  ...
  const attributes = new Map([['data-theme-init', '']]);
  ...
  assert.equal(attributes.has('data-theme-init'), false);
  ...
  assert.equal(light.classList.has('is-active'), true);
  ...
  console.log('PRD 4 shared theme executor checks passed');
})();
